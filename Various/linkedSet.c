/*
 * Filename:	linkedSet.c
 * Author:      Andrew Laing
 * Email:       parisianconnections@gmail.com
 * Date:        02/08/2017
 * Description: Linked Set (Linked List).
 */
...
void insert( ListNodePtr *sPtr, char value )
{
	...
	if( newPtr != NULL ) {
		...
		if( currentPtr != NULL && value == currentPtr->data ) {
			printf( "%c not inserted, because duplicate exists.\n", value );
			free( newPtr );  /* Free the unused memory aqssigned to newPtr */
		}
