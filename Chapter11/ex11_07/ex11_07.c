 ...
 *                 createMaster, populateMaster,
 *                 createTrans, populateTrans
...
int main()
{ 
    /* First create the blank newMast.dat file */
    FILE *nfPtr = fopen("newMast.dat", "wb+");
    fclose(nfPtr);
    
    /* Next copy oldMast to newMast*/
...
void updateNewMaster( FILE *nfPtr )
{
